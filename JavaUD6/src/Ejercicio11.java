...
public static void main(String[] args) {
		...
		introducirarraytamanio();
	}

	public static void introducirarraytamanio() {
		
int lista = Integer.parseInt(JOptionPane.showInputDialog("Introduce el tamaño máximo del array"));
